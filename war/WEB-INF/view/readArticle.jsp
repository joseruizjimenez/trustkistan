...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xml:lang="en" lang="en"> 
	<head>
		...
		<link rel="canonical" href="http://trustkistan.appspot.com/article<%=article.getCleanURL()%>" />
	...
	<body>
        ...
        <%if(article != null) { %>
                    <article>
						...
						<div class="social"><g:plusone size="small"></g:plusone><fb:like href="http://trustkistan.appspot.com/article<%=article.getCleanURL()%>" layout="button_count" send="false" show_faces="false" action="like" ></fb:like></div>
						<div class="comments"><fb:comments href="http://trustkistan.appspot.com/article<%=article.getCleanURL()%>" num_posts="3" width="500"></fb:comments></div>
					</article>
					<h4><a href="http://trustkistan.appspot.com"> Back </a></h4>
